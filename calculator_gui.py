...
visor = tk.StringVar()
campo = tk.Entry(
    janela,textvariable=visor, font=("arial", 20), bd=10, justify = "right")

campo.grid(row=0, column=0, columnspan=4, sticky="we")
lista_botoes = [
    ('7',1,0), ('8', 1, 1), ('9', 1, 2), ("/", 1, 3), ('4',2,0), ('5',2,1), ('6',2,2), ('*',2,3),
...
botao_limpar.grid(row=5, column=0, columnspan=4, stick="we")
